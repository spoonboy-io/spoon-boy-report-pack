...
class SpoonBoyReportPackReportProvider extends AbstractReportProvider{
	protected MorpheusContext morpheusContext
	protected Plugin plugin

	SpoonBoyReportPackReportProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	@Override
	String getCode() {
		return "spoon-boy-report-pack-report"
	}
	...
	HTMLResponse renderTemplate(ReportResult reportResult, Map<String, List<ReportResultRow>> reportRowsBySection) {
		...
		model.object = reportRowsBySection
		getRenderer().renderTemplate("hbs/spoonBoyReportPackReport", model)
	}
}
