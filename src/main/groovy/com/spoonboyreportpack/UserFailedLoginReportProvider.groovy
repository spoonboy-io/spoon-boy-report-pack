...
class UserFailedLoginReportProvider extends AbstractReportProvider{
	protected MorpheusContext morpheusContext
	protected Plugin plugin

	UserFailedLoginReportProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	@Override
	String getCode() {
		return "spoon-boy-user-failed-login-report"
	}
	...
	void process(ReportResult reportResult) {
		...
		observable.map{ resultRow ->
			...
			data = [
					...
					failedLoginAttempts : resultRow.loginAttempts
			]
	...
	String getDescription() {
		return "Provides information on failed login attempts from enabled user accounts"
	}
	...
	HTMLResponse renderTemplate(ReportResult reportResult, Map<String, List<ReportResultRow>> reportRowsBySection) {
		...
		model.object = reportRowsBySection
		getRenderer().renderTemplate("hbs/userFailedLoginReport", model)
	}
}
