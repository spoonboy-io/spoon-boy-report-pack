...
class UserPasswordExpiredReportProvider extends AbstractReportProvider{
	...
	UserPasswordExpiredReportProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	@Override
	String getCode() {
		return "spoon-boy-user-password-expired-report"
	}
	...
	@Override
	String getName() {
		return "Password Expired User accounts"
	}
	...
	String getDescription() {
		return "Provides a list of users who have an expired password"
	}
	...
	HTMLResponse renderTemplate(ReportResult reportResult, Map<String, List<ReportResultRow>> reportRowsBySection) {
		...
		model.object = reportRowsBySection
		getRenderer().renderTemplate("hbs/userPasswordExpiredReport", model)
	}
}
