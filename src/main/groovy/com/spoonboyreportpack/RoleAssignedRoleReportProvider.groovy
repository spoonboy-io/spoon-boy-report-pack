...
class RoleAssignedRoleReportProvider extends AbstractReportProvider{
	...
	@Override
	String getCode() {
		return "spoon-boy-role-assigned-role-report"
	}
	...
	String getDescription() {
		return "Provides information on how roles have been assigned in this Morpheus appliance"
	}
	...
	HTMLResponse renderTemplate(ReportResult reportResult, Map<String, List<ReportResultRow>> reportRowsBySection) {
		...
		model.object = reportRowsBySection
		getRenderer().renderTemplate("hbs/roleAssignedRoleReport", model)
	}
}
