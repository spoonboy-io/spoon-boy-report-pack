...
class UserAccountLockedReportProvider extends AbstractReportProvider{
	protected MorpheusContext morpheusContext
	protected Plugin plugin

	UserAccountLockedReportProvider(Plugin plugin, MorpheusContext morpheusContext) {
	...
	@Override
	String getCode() {
		return "spoon-boy-user-account-locked-report"
	}
	...
	HTMLResponse renderTemplate(ReportResult reportResult, Map<String, List<ReportResultRow>> reportRowsBySection) {
		...
		model.object = reportRowsBySection
		getRenderer().renderTemplate("hbs/userAccountLockedReport", model)
	}
}
